...
AbilityDefinition {
  ...
  // Activation
  cooldown:          float?             // seconds between uses; 0 = no cooldown; null = no cooldown
  ...
  // ── Passive ability fields (used when activationType = "passive") ──────────

  passiveEffect:     PassiveEffect?     // see §17.5
}
```
